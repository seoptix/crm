...
{strip}
    ...
    <div class="navbar commonActionsContainer noprint">
        <div class="actionsContainer row-fluid clearfix">
            <div class="span2">
                <span class="companyLogo"><a href="https://www.seoptix.com/crm"><img src="{$COMPANY_LOGO->get('imagepath')}" title="Enterprise-Ready CRM by SEOptix" alt="SEOptix CRM"/>&nbsp;</a></span>
            </div>
            <div class="span10">
                <div class="row-fluid">
