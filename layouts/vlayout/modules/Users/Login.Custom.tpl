...
<html>
	<head>
		<title>SEOptix CRM Secure Login Area</title>
	...
	<body>
		<div class="container-fluid login-container">
			<div class="row-fluid">
				<div class="span3">
					<div class="logo"><img src="test/logo/seoptix-logo-horizontal.png">
					<br />
				...
				<div class="span9">
					<div class="helpLinks">
						<a href="https://www.seoptix.com" target="_blank">SEOptix Website</a> |
						<a href="https://www.seoptix.com/contact" target="_blank">Contact Us</a> | 
						<a href="https://www.seoptix.com/box" target="_blank">Cloud Box</a>  
					</div>
				</div>
			</div>
			<div class="row-fluid">
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="carousal-container">
										<div><h2>Enterprise-Ready CRM Solutions</h2></div>
										<ul class="bxslider">
											<li>
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">SEOptix Secure Login Area</h3>
		</div>
			...
			<div class="control-group">
				...
				<div class="controls">
											...
											<div class="login-subscript">
												<small>Authenticated SEOptix members only. Your moves are being logged & monitored.</small>
											</div>
				</div>
						...
						<div class="span6 pull-left" >
							<div class="footer-content">
								<small>&#169 2004-{date('Y')}&nbsp;
									by SEOptix&trade; - <a href="https://www.seoptix.com" target="_blank">Search Engine Optimized Web Design</a> | 
									&nbsp;<a href="https://www.seoptix.com/open">Free Open Source Software</a> | 
									&nbsp;<a href="https://www.seoptix.com/privacy">Privacy Policy</a> </small>
							</div>
						</div>
						<div class="span6 pull-right" >
							<div class="pull-right footer-icons">
								<small>{vtranslate('LBL_CONNECT_WITH_US', $MODULE)}&nbsp;</small>
								<a href="https://www.facebook.com/SEOptix"><img src="layouts/vlayout/skins/images/facebook.png"></a>
								&nbsp;<a href="https://twitter.com/SEOptix"><img src="layouts/vlayout/skins/images/twitter.png"></a>
							</div>
						</div>
					</div>   
				</div>    
