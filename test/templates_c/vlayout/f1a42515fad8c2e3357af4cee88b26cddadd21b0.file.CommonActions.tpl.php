<?php /* Smarty version Smarty-3.1.7, created on 2016-09-21 12:36:40
         compiled from "/home/seoptix/public_html/crm/includes/runtime/../../layouts/vlayout/modules/Vtiger/CommonActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:179532289257e234906f0128-38124775%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f1a42515fad8c2e3357af4cee88b26cddadd21b0' => 
    array (
      0 => '/home/seoptix/public_html/crm/includes/runtime/../../layouts/vlayout/modules/Vtiger/CommonActions.tpl',
      1 => 1474461394,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '179532289257e234906f0128-38124775',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_57e234907b79d',
  'variables' => 
  array (
    'ANNOUNCEMENT' => 0,
    'USER_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_57e234907b79d')) {function content_57e234907b79d($_smarty_tpl) {?>

<?php $_smarty_tpl->tpl_vars["announcement"] = new Smarty_variable($_smarty_tpl->tpl_vars['ANNOUNCEMENT']->value->get('announcement'), null, 0);?><?php $_smarty_tpl->tpl_vars['count'] = new Smarty_variable(0, null, 0);?><?php $_smarty_tpl->tpl_vars["dateFormat"] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('date_format'), null, 0);?><div class="navbar commonActionsContainer noprint"><div class="actionsContainer row-fluid clearfix"><div class="span2"><span class="companyLogo"><a href="https://www.seoptix.com/crm"><img src="<?php echo $_smarty_tpl->tpl_vars['COMPANY_LOGO']->value->get('imagepath');?>
" title="Enterprise-Ready CRM by SEOptix" alt="SEOptix CRM"/>&nbsp;</a></span></div><div class="span10"><div class="row-fluid"><div class="searchElement span8"><div class="select-search"><select class="chzn-select" id="basicSearchModulesList" style="width:150px;"><option value="" class="globalSearch_module_All"><?php echo vtranslate('LBL_ALL_RECORDS',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
